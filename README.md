...
- ลองค้นหา healthy tongue dataset มาเพิ่มดูครับ เพราะ healthy tongue ที่มีอยู่แล้วมีเพียงแค่ <em>11 รูป</em> ในโฟลเดอร์ train และผมหา dataset เจอทั้งหมด 3 ตัว ผมคิดว่าจะดึงแค่ตัว healthy tongue มาเติมเต็ม
...
<p>และก็เจอ <b>Detecting Coated Tongue with Convolutional Neural Networks</b> เป็น<br>
1. <b>Binary Classification</b> แยกฝ้าครับ ความแม่นยำ 0.85 และเป็นแค่แยก 2 กลุ่มเท่านั้นครับ คือ เป็นฝ้า vs ไม่เป็นฝ้า แต่ในส่วนของ สีของฝ้า เขาไม่ได้ทำครับ</p>
